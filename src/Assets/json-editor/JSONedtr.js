    ...
    JSONedtr.level = function(node, lvl = 0) {
        ...
        $.each(node, function(key, value) {
            ...
            if (typeof value == 'object') {
                ...
                output += '<div class="jse--row jse--row--array" id="jse--row-' + JSONedtr.i + '"><div class="jse--container"><input type="text" class="jse--key jse--array" data-level="' + lvl + '" value="' + key + '"> : <span class="jse--typeof">(' + type + ')</span></div>';
                ...
                output += '<div class="jse--row" id="jse--row-' + JSONedtr.i + '"><div class="jse--container"><input type="text" class="jse--key" data-level="' + lvl + '" value="' + key + '"> : <span class="jse--typeof">(' + typeof value + ')</span><input type="text" class="jse--value" value="' + value + '" data-key="' + key + '"><div class="jse--delete">✖</div></div></div>';
            }
        })
    ...
    JSONedtr.getData = function(node = $(JSONedtr.outputElement + ' > .jse--row > .jse--container > input')) {
        ...
        $.each(node, function() {
            ...
            if ($(this).hasClass('jse--value') && $(this).attr("type") == "checkbox") {
                if ($(this).is(':checked')) {
                    result[$(this).data('key')] = true;
                } else {
                    result[$(this).data('key')] = false;
                }
