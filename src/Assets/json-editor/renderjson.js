...
var module, window, define, renderjson = (function() {
    ...
    var A = function A(txt, classname, callback, html = false) {
        var a = document.createElement("a");
        if (classname) a.className = classname;
        if (html) {
            var divAux = document.createElement('div');
            divAux.innerHTML = txt.trim();
            a.appendChild(divAux.firstChild);
        } else {
    ...
    function _renderjson(json, indent, dont_indent, show_level, options) {
        ...
        var disclosure = function(open, placeholder, close, type, builder) {
            ...
            append(empty,
                A(options.show, "disclosure", show, options.inconsHtml),
    ...
    renderjson.set_icons = function(show, hide, html = false) {
        renderjson.options.show = show;
        renderjson.options.hide = hide;
        renderjson.options.inconsHtml = html;
        return renderjson;
    };
