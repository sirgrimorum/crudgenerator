...
return [
    "labels" => [
        ...
        "request" => "Request",
        "reportar" => "Status",
        "created_at" => "First report",
        "updated_at" => "Last report",
    ...
    "messages" => [
        ...
        'no_report_success' => '<strong>Great!</strong> All errors of this type will no longer be reported',
        'report_success' => '<strong>Great!</strong> All errors of this type will be reported again',
