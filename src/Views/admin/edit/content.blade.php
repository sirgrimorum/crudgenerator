...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">{{ \Illuminate\Support\Arr::get(__("crudgenerator::" . strtolower($modelo) . ".titulos"), "edit", __('crudgenerator::admin.layout.labels.edit') . " " .ucfirst($singulares)) }}</li>
    </ol>
</nav>
