...
@section('contenido')
<h1>{{ ucfirst($plurales) }} <a href='{{ url($base_url . "/" . $plural .'/create') }}' class='pull-right btn btn-info' ><span class='glyphicon glyphicon-plus' aria-hidden='true'></span> {{ trans('crudgenerator::admin.layout.crear') }} {{ $singulares }}</a></h1>
