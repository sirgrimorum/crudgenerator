...
$config['botones'] = [
    ...
    'remove' => "<a class='btn btn-danger' href='" . route("{model}.destroy",["localecode"=>App::getLocale(),"{model}"=>":modelId"]) . "' data-confirm='" . $textConfirm . "' data-yes='" . trans('crudgenerator::admin.layout.labels.yes') . "' data-no='" . trans('crudgenerator::admin.layout.labels.no') . "' data-confirmtheme='" . config('sirgrimorum.crudgenerator.confirm_theme') . "' data-confirmicon='" . config('sirgrimorum.crudgenerator.icons.confirm') . "' data-confirmtitle='' data-method='delete' rel='nofollow' title='" . trans('crudgenerator::datatables.buttons.t_remove') . " " . $plurales . "'>". trans("crudgenerator::datatables.buttons.remove") . "</a>",
