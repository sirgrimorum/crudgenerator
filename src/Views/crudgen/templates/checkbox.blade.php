...
<div class="form-group row {{$config['class_formgroup']}} {{ $extraClassDiv }}" data-tipo='contenedor-campo'
    ...
    <div class="{{ $config['class_offset'] }} {{ $config['class_divinput'] }}">
                ...
                <div class="input-group {{ ($infoOpcion != '') ? 'mb-0' : 'mb-3' }} {{ $extraClassDiv }}">
                    <div class="input-group-prepend">
                        <div class="input-group-text">
                            {{ Form::checkbox($extraId . "[]", $valor, $checked, $arrayDato) }}
                        </div>
                    </div>
                    ...
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <small class="text-muted" style="white-space: normal;"  id="{{ $tabla . '_' . $extraId . '_' . $valor }}_help">
                                {{ $descriptionOpcion }}
                            </small>
                        </div>
                    </div>
        ...
        <div class="input-group {{ ($help != '') ? 'mb-0' : 'mb-3' }}">
            <div class="input-group-prepend">
                <div class="input-group-text">
                    {{ Form::checkbox($extraId, $datos['value'], $checked, array_merge(
                        $extraDataInput,
            ...
            <div class="input-group-append">
                <div class="input-group-text">
                    <small class="text-muted" style="white-space: normal;" id="{{ $tabla . '_' . $extraId }}_help">
                        {{ $datos['description'] }}
                    </small>
                </div>
            </div>
