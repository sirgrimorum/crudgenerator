 ...
 * structure:
            ...
            "botones" => [ //option A for lists using <a tag to load Button options
                ...
                'remove' => "<a class='btn btn-danger' href='__route__sirgrimorum_modelo::destroy,{'localecode':'__getLocale__','modelo':'article','registro':':modelId'}__' data-confirm='__trans__crudgenerator::admin.messages.confirm_destroy__' data-yes='__trans__crudgenerator::admin.layout.labels.yes__' data-no='__trans__crudgenerator::admin.layout.labels.no__' data-confirmtheme='" . config('sirgrimorum.crudgenerator.confirm_theme'). "' data-confirmicon='" . config('sirgrimorum.crudgenerator.confirm_icon'). "' data-confirmtitle='' data-method='delete' rel='nofollow' title='__trans__crudgenerator::datatables.buttons.t_remove__ Articles'>__trans__crudgenerator::datatables.buttons.remove__</a>",
